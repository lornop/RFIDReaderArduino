...
public:
	...
	//THis is my function to get just the UID and no extra stuff!
	void PICC_DumpUIDToSerial(Uid *uid); //Copied from PICC_DumpDetailsToSerial
	String PICC_DumpUIDToString(Uid *uid);    //send the UID to a string
